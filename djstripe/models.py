...
from six import PY3, text_type, python_2_unicode_compatible
...
class StripeObject(models.Model):
    ...
    def __str__(self):
        return text_type("<{list}>".format(list=", ".join(self.str_parts())))
...
class BankAccount(StripeObject):
    ...
    default_for_currency = StripeBooleanField(
        null=True,
...
class Product(StripeObject):
    ...
    active = StripeBooleanField(null=True, help_text=(
    ...
    caption = StripeCharField(null=True, max_length=5000, stripe_required=False, help_text=(
    ...
    shippable = StripeBooleanField(null=True, stripe_required=False, help_text=(
        "Whether this product is a shipped good. "
        "Only applicable to products of `type=good`."
    ))
    url = StripeCharField(max_length=799, null=True, stripe_required=False, help_text=(
...
class Account(StripeObject):
    ...
    debit_negative_balances = StripeBooleanField(stripe_required=False, null=True, default=False, help_text=(
